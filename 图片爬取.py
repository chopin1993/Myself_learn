...
if not os.path.exists("F:/坏叔街拍美女"):  # 在F盘创建一个文件夹来存储图片数据
    os.mkdir("F:/坏叔街拍美女")

url = "https://www.huaishu520.com/detail?id=2128"
headers = {
...
td_list = tree.xpath("//div[@class='images show-images-box']/img/@src")  # xpath解析网页文件
print(td_list)
for p_url in td_list:
    ...
    img_path = "F:/坏叔街拍美女/" + img_name  # 路径和文件名
